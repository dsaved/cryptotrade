    ...
    async run() {
        ...
        if (this._query !== null) {
            ...
            if (this._condition !== null) {
                ...
                this._query = 'SELECT  * FROM  ' + this._table + ' ' + this._condition + '  LIMIT ' + this.limit + ' OFFSET ' + this.offset;
                await this.query(this._query);
            } else {
                this._query = 'SELECT  * FROM  ' + this._table + ' ORDER BY (SELECT NULL) LIMIT ' + this.limit + ' OFFSET ' + this.offset;
                await this.query(this._query);
            }
        }
    }
